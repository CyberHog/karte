...
(function() {
  $(document).on("ready turbolinks:load", function() {
    var Is_this_a_coupon;
    Is_this_a_coupon = function() {
...
(function() {
  $(document).on("ready turbolinks:load", function() {
    var change_practice;
    change_practice = function() {
      if ($("#clinic").prop("checked")) {
        return $("#private_user").show();
      } else {
        return $("#private_user").hide();
      }
    };
    $("#clinic").bind("click", change_practice);
    return change_practice();
  });
  ...
  $(document).on("ready turbolinks:load", function() {
    ...
    change_expired_at = function() {
      if ($("#notice_no_expiration").prop("checked")) {
        return $("#notice_expired_at").hide();
      } else {
        return $("#notice_expired_at").show();
      }
    };
